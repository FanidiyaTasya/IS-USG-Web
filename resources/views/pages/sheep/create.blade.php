                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3 d-flex justify-content-center">
                                @if ($sheep->sheep_photo)
                                    <img src="{{ asset('storage/' . $sheep->sheep_photo) }}" class="img-preview img-fluid rounded fixed-img-create">
                                @else
                                    <img src="{{ asset('assets/images/sheep/sheep_vector.jpeg') }}" class="img-preview img-fluid rounded fixed-img-create">
                                @endif
                            </div>
                            <input type="file" class="form-control" name="sheep_photo" id="sheep_photo" onchange="previewImage()" accept="image/*">
                        </div>
                    </div>
                </div>
